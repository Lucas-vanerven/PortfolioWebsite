          ...
          dialogContent: {
            ...
            curriculum: [
              ...
              { year: 1, courses: [
                ...
                { name: 'Java in Practice', status: 'Afgerond', credits: 3 },
                { name: 'Java in Theory', status: 'Afgerond', credits: 3 },
                { name: 'Characteristic Occupational Situation', status: 'Afgerond', credits: 15 },
